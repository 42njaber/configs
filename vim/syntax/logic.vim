syntax keyword Special property bounds data relation relations reference assume statements operand operands constructor syntax semantic
syntax keyword Operator is extends binds enriches masking alias require from explicit implicit using given

syntax keyword Type any bit-array
