...
function! <SID>Tex_SetCompilerMaps()
	...
	call Tex_MakeMap(s:ml."tl", "<Plug>Tex_Compile", 'n', '<buffer>')
	call Tex_MakeMap(s:ml."tl", "<Plug>Tex_Compile", 'v', '<buffer>')
	call Tex_MakeMap(s:ml."tv", "<Plug>Tex_View", 'n', '<buffer>')
	call Tex_MakeMap(s:ml."ts", "<Plug>Tex_ForwardSearch", 'n', '<buffer>')
endfunction
" }}}
